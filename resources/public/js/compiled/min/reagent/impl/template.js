...
var G__22677 = o;
goog.object.set(G__22677,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22681 = o;
goog.object.set(G__22681,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__22685 = props;
var G__22685__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__22685,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22685);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22685__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__22685__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__22686 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22686,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__22686;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22687){
...
var on_write = cljs.core.get.call(null,map__22688__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__22690_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22690_SHARP_);
}));
} else {
return null;
}
...
var vec__22693 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22693,(0),null);
var id = cljs.core.nth.call(null,vec__22693,(1),null);
var className = cljs.core.nth.call(null,vec__22693,(2),null);
...
var temp__5724__auto___22697 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___22697 == null)){
} else {
var key_22698 = temp__5724__auto___22697;
(jsprops.key = key_22698);
}
...
var temp__5724__auto___22699 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___22699 == null)){
} else {
var key_22700 = temp__5724__auto___22699;
...
var temp__5724__auto___22701 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___22701 == null)){
} else {
var key_22702 = temp__5724__auto___22701;
...
var G__22704 = n;
if(cljs.core._EQ_.call(null,"",G__22704)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22705){
...
break;
default:
var G__22712 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__22712;
continue;
...
var ctx = ({});
var vec__22714 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__22714,(0),null);
var derefed = cljs.core.nth.call(null,vec__22714,(1),null);
...
var G__22717 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22717) {
case (0):
