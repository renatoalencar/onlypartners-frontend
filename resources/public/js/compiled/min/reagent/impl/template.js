...
var G__26497 = o;
goog.object.set(G__26497,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26498__delegate = function (args){
...
while (G__26499__i < G__26499__a.length) {G__26499__a[G__26499__i] = arguments[G__26499__i + 0]; ++G__26499__i;}
  args = new cljs.core.IndexedSeq(G__26499__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26500);
...
var G__26501 = o;
goog.object.set(G__26501,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26503__i < G__26503__a.length) {G__26503__a[G__26503__i] = arguments[G__26503__i + 0]; ++G__26503__i;}
  args = new cljs.core.IndexedSeq(G__26503__a,0,null);
} 
...
var G__26505 = props;
var G__26505__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26505,cljs.core.cst$kw$id,id):G__26505);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26505__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__26505__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26506 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26506,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26506;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26507){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26508__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__26510_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26510_SHARP_);
}));
} else {
return null;
}
...
var vec__26513 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26513,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26513,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26513,(2),null);
...
var temp__5724__auto___26517 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___26517 == null)){
} else {
var key_26518 = temp__5724__auto___26517;
...
var temp__5724__auto___26519 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___26519 == null)){
} else {
var key_26520 = temp__5724__auto___26519;
(jsprops.key = key_26520);
}
...
var G__26521 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26521) : reagent.impl.template.as_element.call(null,G__26521));
} else {
var temp__5724__auto___26522 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___26522 == null)){
} else {
var key_26523 = temp__5724__auto___26522;
(jsprops.key = key_26523);
}
...
var G__26525 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__26525)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26526){
...
var ctx = ({});
var vec__26535 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26535,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26535,(1),null);
...
var G__26538 = (cljs.core.count(argv) - first_child);
switch (G__26538) {
case (0):
...
break;
case (1):
var G__26539 = component;
var G__26540 = jsprops;
var G__26541 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.node$module$react.createElement(G__26539,G__26540,G__26541);
