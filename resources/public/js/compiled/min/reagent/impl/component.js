...
if((i < len)){
var k = (ks[i]);
var G__26452 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__26453 = (i + (1));
m = G__26452;
i = G__26453;
continue;
...
var temp__5722__auto__ = p.argv;
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__26454 = p.children;
return reagent.impl.component.node$module$react.Children.toArray(G__26454);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26456 = c;
var G__26456__$1 = (((G__26456 == null))?null:G__26456.prototype);
if((G__26456__$1 == null)){
return null;
} else {
return G__26456__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26458 = c;
var G__26458__$1 = (((G__26458 == null))?null:G__26458.prototype);
if((G__26458__$1 == null)){
return null;
} else {
return G__26458__$1.render;
}
})() == null)))));
});
...
var G__26460 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26460) : reagent.impl.component.as_element.call(null,G__26460));
};
...
var G__26466 = c;
var G__26466__$1 = (((G__26466 == null))?null:G__26466.constructor);
if((G__26466__$1 == null)){
return null;
} else {
return G__26466__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__26467 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26468 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26468);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26467);
}});
...
var c = this;
var G__26472_26474 = goog.object.get(c,"cljsRatom");
if((G__26472_26474 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26472_26474);
}
...
var renders_26475 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_26476 = cljs.core.first(cljs.core.vals(renders_26475));
...
if((cljs.core.count(renders_26475) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26475))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26476)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26476], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26477 = o;
goog.object.set(G__26477,cljs.core.name(k),v);
