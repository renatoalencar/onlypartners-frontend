...
return cljs.core.reduce.call(null,(function (result,p__28801){
...
var vec__28805 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__28805,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__28805,(1),null);
var ab = cljs.core.nth.call(null,vec__28805,(2),null);
...
return clojure$data$EqualityPartition$equality_partition$dyn_28811.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_28812 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_28812.call(null,a,b);
}
});
...
return (function (){var G__28816 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28816__$1)].join('')));
