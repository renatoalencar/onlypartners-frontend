...
var vec__23157 = cljs.core.re_matches.call(null,/(\d{2})\/?(\d{2})/,date);
var match = cljs.core.nth.call(null,vec__23157,(0),null);
var month = cljs.core.nth.call(null,vec__23157,(1),null);
var year = cljs.core.nth.call(null,vec__23157,(2),null);
...
var vec__23160 = cljs.core.re_matches.call(null,/(\d{2})\/?(\d{0,2})/,date);
var match = cljs.core.nth.call(null,vec__23160,(0),null);
var month = cljs.core.nth.call(null,vec__23160,(1),null);
var year = cljs.core.nth.call(null,vec__23160,(2),null);
...
var vec__23164 = onlypartners.components.mask.use_mask.call(null,onlypartners.components.credit_card.valid_date_format_QMARK_,onlypartners.components.credit_card.format_date);
var date = cljs.core.nth.call(null,vec__23164,(0),null);
var set_date_BANG_ = cljs.core.nth.call(null,vec__23164,(1),null);
var vec__23167 = onlypartners.components.validation.use_validation.call(null,"Expira\u00E7\u00E3o \u00E9 obrigat\u00F3rio",cljs.core.empty_QMARK_,"Data \u00E9 inv\u00E1lida",cljs.core.comp.call(null,cljs.core.not,onlypartners.components.credit_card.valid_date_QMARK_));
var error = cljs.core.nth.call(null,vec__23167,(0),null);
var validate_BANG_ = cljs.core.nth.call(null,vec__23167,(1),null);
return (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.label","label.label",725637336),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"for","for",-1323786319),new cljs.core.Keyword(null,"expiration-date","expiration-date",-1266973669)], null),"Expira\u00E7\u00E3o"], null),(cljs.core.truth_(error.call(null))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.field__error","span.field__error",293560684),error.call(null)], null):null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input#expiration-date.field","input#expiration-date.field",-2021117081),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"class","class",-2030961996),onlypartners.util.classes.call(null,new cljs.core.Keyword(null,"field--invalid","field--invalid",-1287614816),error),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"expiration-date","expiration-date",-1266973669),new cljs.core.Keyword(null,"value","value",305978217),date.call(null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__23163_SHARP_){
return set_date_BANG_.call(null,p1__23163_SHARP_.target.value);
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),(function (){
return validate_BANG_.call(null,date.call(null));
}),new cljs.core.Keyword(null,"inputMode","inputMode",-1531650881),new cljs.core.Keyword(null,"numeric","numeric",-1495594714),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"DD / AA"], null)], null),(function (){var vec__23170 = cljs.core.re_matches.call(null,/(\d{2})\/(\d{2})/,date.call(null));
var match = cljs.core.nth.call(null,vec__23170,(0),null);
var month = cljs.core.nth.call(null,vec__23170,(1),null);
var year = cljs.core.nth.call(null,vec__23170,(2),null);
if((!((match == null)))){
...
var vec__23174 = onlypartners.components.validation.use_validation.call(null,"Nome \u00E9 obrigat\u00F3rio",cljs.core.empty_QMARK_);
var error = cljs.core.nth.call(null,vec__23174,(0),null);
var validate_BANG_ = cljs.core.nth.call(null,vec__23174,(1),null);
return (function (){
...
})),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"data-checkout","data-checkout",1904349121),new cljs.core.Keyword(null,"cardholderName","cardholderName",1300897754),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,owner),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__23173_SHARP_){
return cljs.core.reset_BANG_.call(null,owner,p1__23173_SHARP_.target.value);
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),(function (){
...
var vec__23177 = cljs.core.re_matches.call(null,onlypartners.components.credit_card.card_number_pattern,card_number);
var seq__23178 = cljs.core.seq.call(null,vec__23177);
var first__23179 = cljs.core.first.call(null,seq__23178);
var seq__23178__$1 = cljs.core.next.call(null,seq__23178);
var match = first__23179;
var parts = seq__23178__$1;
...
var vec__23181 = onlypartners.components.mask.use_mask.call(null,onlypartners.components.credit_card.valid_card_number_QMARK_,onlypartners.components.credit_card.format_card_number);
var card_number = cljs.core.nth.call(null,vec__23181,(0),null);
var set_card_number_BANG_ = cljs.core.nth.call(null,vec__23181,(1),null);
var vec__23184 = onlypartners.components.validation.use_validation.call(null,"N\u00FAmero do cart\u00E3o \u00E9 obrigat\u00F3rio",cljs.core.empty_QMARK_);
var error = cljs.core.nth.call(null,vec__23184,(0),null);
var validate_BANG_ = cljs.core.nth.call(null,vec__23184,(1),null);
return (function (){
...
return (!((error.call(null) == null)));
})),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"data-checkout","data-checkout",1904349121),new cljs.core.Keyword(null,"cardNumber","cardNumber",243741922),new cljs.core.Keyword(null,"value","value",305978217),card_number.call(null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__23180_SHARP_){
return set_card_number_BANG_.call(null,p1__23180_SHARP_.target.value);
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),(function (){
...
var vec__23188 = onlypartners.components.mask.use_mask.call(null,cljs.core.partial.call(null,cljs.core.re_matches,/^\d{0,3}$/));
var security_code = cljs.core.nth.call(null,vec__23188,(0),null);
var set_security_code_BANG_ = cljs.core.nth.call(null,vec__23188,(1),null);
var vec__23191 = onlypartners.components.validation.use_validation.call(null,"C\u00F3digo \u00E9 obrigat\u00F3rio",cljs.core.empty_QMARK_);
var error = cljs.core.nth.call(null,vec__23191,(0),null);
var validate_BANG_ = cljs.core.nth.call(null,vec__23191,(1),null);
return (function (){
...
return (!((error.call(null) == null)));
})),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"data-checkout","data-checkout",1904349121),new cljs.core.Keyword(null,"securityCode","securityCode",-1098270131),new cljs.core.Keyword(null,"value","value",305978217),security_code.call(null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__23187_SHARP_){
return set_security_code_BANG_.call(null,p1__23187_SHARP_.target.value);
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),(function (){
