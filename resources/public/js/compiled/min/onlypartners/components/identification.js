...
var vec__23212 = cljs.core.re_matches.call(null,onlypartners.components.identification.cpf_format,cpf);
var match = cljs.core.nth.call(null,vec__23212,(0),null);
var p1 = cljs.core.nth.call(null,vec__23212,(1),null);
var p2 = cljs.core.nth.call(null,vec__23212,(2),null);
var p3 = cljs.core.nth.call(null,vec__23212,(3),null);
var digit = cljs.core.nth.call(null,vec__23212,(4),null);
...
var get_digit = (function (p1__23215_SHARP_){
return ((11) - cljs.core.mod.call(null,cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,cljs.core.take.call(null,p1__23215_SHARP_,digits),cljs.core.reverse.call(null,cljs.core.range.call(null,(2),(p1__23215_SHARP_ + (2)))))),(11)));
});
...
var vec__23217 = onlypartners.components.mask.use_mask.call(null,onlypartners.components.identification.valid_cpf_format_QMARK_,onlypartners.components.identification.format_cpf);
var cpf = cljs.core.nth.call(null,vec__23217,(0),null);
var set_cpf_BANG_ = cljs.core.nth.call(null,vec__23217,(1),null);
var vec__23220 = onlypartners.components.validation.use_validation.call(null,"CPF \u00E9 obrigat\u00F3rio",cljs.core.empty_QMARK_,"CPF n\u00E3o \u00E9 v\u00E1lido",cljs.core.comp.call(null,cljs.core.not,onlypartners.components.identification.valid_cpf_QMARK_));
var error = cljs.core.nth.call(null,vec__23220,(0),null);
var validate_BANG_ = cljs.core.nth.call(null,vec__23220,(1),null);
return (function (){
...
})),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"data-checkout","data-checkout",1904349121),new cljs.core.Keyword(null,"docNumber","docNumber",-1719173346),new cljs.core.Keyword(null,"value","value",305978217),cpf.call(null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__23216_SHARP_){
return set_cpf_BANG_.call(null,p1__23216_SHARP_.target.value);
...
var vec__23224 = onlypartners.components.validation.use_validation.call(null,"E-mail \u00E9 obrigat\u00F3rio",cljs.core.empty_QMARK_);
var error = cljs.core.nth.call(null,vec__23224,(0),null);
var validate_BANG_ = cljs.core.nth.call(null,vec__23224,(1),null);
return (function (){
...
return (!((error.call(null) == null)));
})),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"email","email",1415816706),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"email","email",1415816706),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,email),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__23223_SHARP_){
return cljs.core.reset_BANG_.call(null,email,p1__23223_SHARP_.target.value);
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),(function (){
