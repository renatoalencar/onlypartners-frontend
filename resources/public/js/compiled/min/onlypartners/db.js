...
onlypartners.db.register_payment = (function onlypartners$db$register_payment(payment){
return cljs.core.swap_BANG_.call(null,onlypartners.db.db,cljs.core.assoc,new cljs.core.Keyword(null,"payment","payment",-1682035288),payment);
});
